...
const audiences = [
  {
    icon: Building2,
    title: "Empresários de shoppings e lojas premium",
  },
  {
    icon: Wheat,
    title: "Produtores rurais de alto padrão",
  },
  {
    icon: Stethoscope,
  ...
  {
    icon: Tag,
    title: "Marcas que buscam identidade forte",
  },
  {
    icon: CheckCircle,
    title: "Quem valoriza planejamento sobre preço baixo",
  },
];
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-muted/30 rounded-lg p-6 animate-fade-up animate-delay-600">
            <p className="text-muted-foreground text-sm italic">
              "Não atendo projetos improvisados ou sem orçamento para gestão profissional."
            </p>
          </div>
        </div>
      </div>
