...
export const translations = {
  'pt-BR': {
    // Header
    'header.about': 'Sobre',
    'header.differentials': 'Diferenciais',
    ...
    // Journey Section
    'journey.title': 'Minha Jornada Pessoal',
    'journey.paragraph1': 'Eu sou <strong>Emily Cristine</strong>, arquiteta e urbanista com mais de 10 anos de experiência, especialista em projetos arquitetônicos, sustentabilidade e neuroarquitetura.',
    'journey.paragraph2': 'Mas minha história vai além da formação técnica: em 2018, durante uma gravidez delicada, vivi uma experiência de quase-morte que mudou tudo. Naquele momento limite, entendi minha missão verdadeira – usar a arquitetura para acolher, curar e transformar vidas através de espaços com propósito e fé cristã.',
    ...
    'differentials.items.transparent.description': 'Orçamentos por etapas, sem surpresas ou improvisos.',
    'differentials.items.tracking.title': 'Acompanhamento total da obra',
    'differentials.items.tracking.description': 'Do conceito à entrega final, com controle de prazos.',
    'differentials.items.humanized.title': 'Abordagem humanizada',
    ...
    'projects.categories.interiors': 'Interiores',
    'projects.lightbox.close': 'Fechar',
    'projects.lightbox.altExpanded': 'Projeto ampliado',
    ...
    'projects.other1.item1': 'Interiores humanizados para marcas de luxo',
    'projects.other1.item2': 'Sustentabilidade integrada',
    'projects.other1.item3': 'Foco na experiência do usuário',
    'projects.other2.title': 'Clínicas e Laboratórios',
    'projects.other2.item1': 'Projetos com normas técnicas rigorosas (ANVISA)',
    'projects.other2.item2': 'Fluxos otimizados',
    'projects.other2.item3': 'Gestão que evita retrabalhos caros',
    'projects.other3.title': 'Residenciais Agro-Rural de Luxo',
    'projects.other3.item1': 'Layouts humanizados',
    'projects.other3.item2': 'Sustentabilidade aplicada ao agro premium',
    ...
    'testimonials.items.lgClient.quote': 'Gestão impecável no shopping. Sem surpresas, só resultados.',
    'testimonials.items.lgClient.author': 'Cliente LG Importados',
    'testimonials.items.lgClient.location': 'Palotina/PR',
    'testimonials.items.farmer.quote': 'Transformou minha casa rural sem reformas radicais. Funciona na vida real!',
    'testimonials.items.farmer.author': 'Produtor rural',
    'testimonials.items.farmer.location': 'Oeste PR',
    ...
    'process.items.budget.description': 'Transparência total com custos divididos e sem surpresas.',
    'process.items.management.title': 'Gestão da obra',
    'process.items.management.description': 'Acompanhamento presencial garantindo qualidade e prazos.',
    'process.items.delivery.title': 'Entrega com alma',
    'process.items.delivery.description': 'Seu espaço pronto para transformar sua vida e rotina.',

    // CTA Section
    'cta.title': 'Projeto bem feito não é luxo.<br /><span class="text-primary-foreground/80">É investimento inteligente.</span>',
    'cta.subtitle': 'Com experiência binacional e abordagem humanizada, entrego resultados que duram décadas.',
    ...
    'common.loadingProjects': 'Carregando projetos destaques...',
  },
  'en': {
    // Header
    'header.about': 'About',
    'header.differentials': 'Differentials',
    ...
    // Journey Section
    'journey.title': 'My Personal Journey',
    'journey.paragraph1': 'I am <strong>Emily Cristine</strong>, an architect and urban planner with over 10 years of experience, specialized in architectural projects, sustainability, and neuroarchitecture.',
    'journey.paragraph2': 'But my story goes beyond technical training: in 2018, during a delicate pregnancy, I experienced a near-death experience that changed everything. At that critical moment, I understood my true mission – to use architecture to welcome, heal, and transform lives through spaces with purpose and Christian faith.',
    ...
    'differentials.items.transparent.description': 'Budgets by stages, without surprises or improvisation.',
    'differentials.items.tracking.title': 'Complete construction monitoring',
    'differentials.items.tracking.description': 'From concept to final delivery, with deadline control.',
    'differentials.items.humanized.title': 'Humanized approach',
    ...
    'projects.categories.interiors': 'Interiors',
    'projects.lightbox.close': 'Close',
    'projects.lightbox.altExpanded': 'Expanded project',
    ...
    'projects.other1.item1': 'Humanized interiors for luxury brands',
    'projects.other1.item2': 'Integrated sustainability',
    'projects.other1.item3': 'Focus on user experience',
    'projects.other2.title': 'Clinics and Laboratories',
    'projects.other2.item1': 'Projects with strict technical standards (ANVISA)',
    'projects.other2.item2': 'Optimized flows',
    'projects.other2.item3': 'Management that avoids expensive rework',
    'projects.other3.title': 'Luxury Agro-Rural Residences',
    'projects.other3.item1': 'Humanized layouts',
    'projects.other3.item2': 'Sustainability applied to premium agro',
    ...
    'testimonials.items.businesswoman.location': 'Palotina/PR',
    'testimonials.items.lgClient.quote': 'Impeccable management at the shopping center. No surprises, just results.',
    'testimonials.items.lgClient.author': 'LG Imports Client',
    'testimonials.items.lgClient.location': 'Palotina/PR',
    'testimonials.items.farmer.quote': 'Transformed my rural house without radical renovations. It works in real life!',
    'testimonials.items.farmer.author': 'Rural Producer',
    'testimonials.items.farmer.location': 'Western PR',
    ...
    'process.items.budget.description': 'Total transparency with divided costs and no surprises.',
    'process.items.management.title': 'Construction management',
    'process.items.management.description': 'On-site monitoring ensuring quality and deadlines.',
    'process.items.delivery.title': 'Delivery with soul',
    'process.items.delivery.description': 'Your space ready to transform your life and routine.',
    ...
    'common.loadingProjects': 'Loading featured projects...',
  },
  'es': {
    // Header
    'header.about': 'Acerca',
    'header.differentials': 'Diferenciales',
    ...
    // Journey Section
    'journey.title': 'Mi Trayectoria Personal',
    'journey.paragraph1': 'Soy <strong>Emily Cristine</strong>, arquitecta y urbanista con más de 10 años de experiencia, especialista en proyectos arquitectónicos, sostenibilidad y neuroarquitectura.',
    'journey.paragraph2': 'Pero mi historia va más allá de la formación técnica: en 2018, durante un embarazo delicado, viví una experiencia cercana a la muerte que lo cambió todo. En ese momento límite, entendí mi verdadera misión: usar la arquitectura para acoger, curar y transformar vidas a través de espacios con propósito y fe cristiana.',
    ...
    'differentials.items.transparent.description': 'Presupuestos por etapas, sin sorpresas ni improvisaciones.',
    'differentials.items.tracking.title': 'Seguimiento total de la obra',
    'differentials.items.tracking.description': 'Del concepto a la entrega final, con control de plazos.',
    'differentials.items.humanized.title': 'Enfoque humanizado',
    ...
    'projects.categories.residential': 'Residencial',
    'projects.categories.interiors': 'Interiores',
    'projects.lightbox.close': 'Cerrar',
    'projects.lightbox.altExpanded': 'Proyecto ampliado',
    ...
    'projects.other1.item1': 'Interiores humanizados para marcas de lujo',
    'projects.other1.item2': 'Sostenibilidad integrada',
    'projects.other1.item3': 'Enfoque en la experiencia del usuario',
    'projects.other2.title': 'Clínicas y Laboratorios',
    'projects.other2.item1': 'Proyectos con normas técnicas rigurosas (ANVISA)',
    'projects.other2.item2': 'Flujos optimizados',
    'projects.other2.item3': 'Gestión que evita costosos retrabajos',
    'projects.other3.title': 'Residenciales Agro-Rural de Lujo',
    'projects.other3.item1': 'Diseños humanizados',
    'projects.other3.item2': 'Sostenibilidad aplicada al agro premium',
    ...
    'testimonials.items.businesswoman.location': 'Palotina/PR',
    'testimonials.items.lgClient.quote': 'Gestión impecable en el centro comercial. Sin sorpresas, solo resultados.',
    'testimonials.items.lgClient.author': 'Cliente LG Importaciones',
    'testimonials.items.lgClient.location': 'Palotina/PR',
    'testimonials.items.farmer.quote': '¡Transformó mi casa rural sin renovaciones radicales. Funciona en la vida real!',
    'testimonials.items.farmer.author': 'Productor Rural',
    'testimonials.items.farmer.location': 'Oeste PR',
    ...
    'process.items.budget.description': 'Transparencia total con costos divididos y sin sorpresas.',
    'process.items.management.title': 'Gestión de la obra',
    'process.items.management.description': 'Seguimiento presencial garantizando calidad y plazos.',
    'process.items.delivery.title': 'Entrega con alma',
    'process.items.delivery.description': 'Su espacio listo para transformar su vida y rutina.',
    ...
    'common.loadingProjects': 'Cargando proyectos destacados...',
  },
};
